 ...
 *事务注解解析接口：目的是解析事务注解。得到元信息。
 * @author Juergen Hoeller
 * @since 2.5
 * @see AnnotationTransactionAttributeSource
 * @see SpringTransactionAnnotationParser  如果是spring的Transactional，那么使用这个解析器
 * @see Ejb3TransactionAnnotationParser 如果是ejb的javax.ejb.TransactionAttribute，那么使用这个解析器
 * @see JtaTransactionAnnotationParser 如果是javax.transaction.Transactional的注解，那么使用这个解析器
 */
