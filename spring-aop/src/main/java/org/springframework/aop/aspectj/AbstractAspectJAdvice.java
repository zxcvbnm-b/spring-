...
public abstract class AbstractAspectJAdvice implements Advice, AspectJPrecedenceInformation, Serializable {
	...
	public final synchronized void calculateArgumentBindings() {
		...
		if (maybeBindJoinPoint(parameterTypes[0]) || maybeBindProceedingJoinPoint(parameterTypes[0]) ||
         ...
         /*看看有没有除了JoinPoint ProceedingJoinPoint StaticPart的参数，如果有，那么获取到参数名称 */
		if (numUnboundArgs > 0) {
	...
	private void bindExplicitArguments(int numArgumentsLeftToBind) {
		...
		/*保存方法名称和方法参数的位置的关系 后面用于根据名称获取到具体的参数的位置用于设置参数的吧*/
		...
		/*如果有使用@AfterReturning注解，那么returningName会有值，但是你在通知方法中也必须要设置返回参数*/
		...
		/*如果有使用@AfterThrowing注解，那么throwingName会有值，但是你在通知方法中也必须要设置异常参数*/
	...
	protected Object[] argBinding(JoinPoint jp, @Nullable JoinPointMatch jpMatch,
		...
		int numBound = 0;
        /*如果通知方法有 joinPoint方法参数 比如xxxMethod（JoinPoint xxx），那么注入jp*/
		if (this.joinPointArgumentIndex != -1) {
			adviceInvocationArgs[this.joinPointArgumentIndex] = jp;
			numBound++;
		}
		/*如果通知方法有 joinPoint方法参数 比如xxxMethod（JoinPoint xxx），那么注入StaticPart--用不到？*/
	...
	protected Object invokeAdviceMethodWithGivenArgs(Object[] args) throws Throwable {
		...
		try {
			...
			// TODO AopUtils.invokeJoinpointUsingReflection  执行通知方法
